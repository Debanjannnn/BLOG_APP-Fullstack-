    ...
    return <div>
        ...
        <div className="flex justify-center w-full pt-8"> 
            <div className="max-w-screen-lg w-full">
                ...
                }} type="submit" className="mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white rounded-xl bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300">
                    Publish post
                </button>
            </div>
        </div>
